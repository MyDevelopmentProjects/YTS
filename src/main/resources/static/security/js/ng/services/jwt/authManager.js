angular.module('angular-jwt.authManager', [])
    .provider('authManager', function () {
        ...
        this.$get = function ($rootScope, $injector, $localStorage,$location, jwtHelper, jwtInterceptor, jwtOptions) {
            ...
            function doAauthentication() {
                authenticate();
                invokeRedirector(config.authenticationSuccessRedirector);
            }
            ...
            function verifyRoute(event, next) {
                ...
                if(routeData && routeData.requiresUnauthenticated === true && isAuthenticated()){
            ...
            return {
                doAauthentication:doAauthentication,
